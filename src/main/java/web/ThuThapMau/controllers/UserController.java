...
public class UserController {
    ...
    public void updatePassword(@PathVariable("user_id") Long user_id, @RequestBody Map<String, String> body) {
        String newPassword = body.get("newUserPassword");
        System.out.println(newPassword + ", " + user_id);
